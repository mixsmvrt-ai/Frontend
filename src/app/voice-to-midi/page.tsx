...
export default function VoiceToMidiPage() {
  ...
  const runPipeline = async () => {
    ...
    setDownloadUrl(null);
    setConversation((current) => [...current, { role: "user", content: `Voice recording: ${file.name}` }]);
