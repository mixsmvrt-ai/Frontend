...
const fieldAliases: Record<string, string[]> = { Name: ["display_name", "name", "full_name", "email"], User: ["display_name", "user_name", "email", "user_id"], Customer: ["display_name", "customer_name", "email", "user_id"], Owner: ["display_name", "owner_name", "email", "user_id"], Profile: ["artist_name", "name"], "Pack name": ["name", "pack_name"], Project: ["name", "project_name"], Subject: ["subject", "title"], "Transaction ID": ["transaction_id", "payment_id", "id"], Plan: ["membership_type", "plan", "plan_name"], Amount: ["amount_cents", "amount", "total_cents"], Method: ["payment_method", "method", "provider"], Category: ["category", "type"], Type: ["type", "project_type"], Genre: ["genre", "primary_genre"], Status: ["membership_status", "status", "active"], Created: ["created_at"], Date: ["created_at", "updated_at", "paid_at"], "Last updated": ["updated_at"], "Last active": ["last_active_at", "updated_at"], Credits: ["credits_balance", "credits_used", "credit_cost"], Referrals: ["referrals", "referral_count", "signups"], Rules: ["rules", "rule_count"], "MIDI count": ["midi_count", "file_count", "count"], Storage: ["storage_size", "size_bytes"], Requests: ["requests", "request_count"], Latency: ["latency_ms", "average_latency_ms"], Tokens: ["tokens", "total_tokens"], Assigned: ["assigned_to", "assignee"], Priority: ["priority"], Scope: ["scope"] };
